...
async function getTemplate(templateId) {
    ...
    let response = await fetch(`https://api.wolfeocrm.com/v1/setting/2/template/${templateId}`, {
        method: 'GET',
        headers: {
            'Content-Type': 'application/json',
            'authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJMVENCV1M4RkRVTkdTMDNUIiwiaXNzIjoiaHR0cHM6Ly9hcGkuaWxvZ2dlcnouY29tL2FwaS92MS9sb2dpbiIsImlhdCI6MTY3Nzc1MzczNCwiZXhwIjoxNjc3NzU3MzM0LCJuYmYiOjE2Nzc3NTM3MzQsImp0aSI6IkxUQ0JXUzhGRFVOR1MwM1QxNjc3NzUzNzM0In0.p8Fbo3pzteWxpJRdawR2g2Gw5JTV7yeUV-v_HQAECiY'
        }
    }).then(async (res) => {
        data = await res.json();
    })
